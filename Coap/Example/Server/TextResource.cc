...
void TextResource::getRequestCallback(coap_resource_t *resource, coap_session_t *session, 
    const coap_pdu_t *request, const coap_string_t *query, coap_pdu_t *response)
{
    ...
    */
    auto uri_path = coap_resource_get_uri_path(resource);
    if (!uri_path) {
...
void TextResource::putRequestCallback(coap_resource_t *resource, coap_session_t *session, 
    const coap_pdu_t *request, const coap_string_t *query, coap_pdu_t *response)
{
...
void TextResource::postRequestCallback(coap_resource_t *resource, coap_session_t *session, 
    const coap_pdu_t *request, const coap_string_t *query, coap_pdu_t *response)
{
...
void TextResource::deleteRequestCallback(coap_resource_t *resource, coap_session_t *session, 
    const coap_pdu_t *request, const coap_string_t *query, coap_pdu_t *response)
{
    coap_pdu_set_code(response, COAP_RESPONSE_CODE_NOT_ALLOWED);
